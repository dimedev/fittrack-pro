// ==================== COACH ENGINE — UNIFIED MODULE ====================
// Fusion physique : SmartTraining + AIInsights + façade CoachEngine
// Chaque section est une IIFE indépendante avec son propre scope.
// Les exports window.SmartTraining et window.AIInsights restent compatibles
// avec tous les consumers existants. Code nouveau : utiliser window.CoachEngine.
// ======================================================================

// ╔════════════════════════════════════════════════════════════════════╗
// ║  PARTIE 1/3 — SMART TRAINING (1638 lignes)                          ║
// ║  Weight suggestions, recovery, fatigue, 1RM, périodisation          ║
// ╚════════════════════════════════════════════════════════════════════╝
        ...
        if (fatiguedMuscles.length > 0) {
            ...
            html += `
                <div class="recovery-fatigued-note">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="vertical-align:-2px"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
                    En récup : ${fatiguedNames}
                </div>
            `;
        }
...
// ╔════════════════════════════════════════════════════════════════════╗
// ║  PARTIE 2/3 — AI INSIGHTS (299 lignes)                              ║
// ║  Weekly digest via Claude API (haiku)                               ║
// ╚════════════════════════════════════════════════════════════════════╝
...
// ╔════════════════════════════════════════════════════════════════════╗
// ║  PARTIE 3/3 — COACH ENGINE FAÇADE (141 lignes)                      ║
// ║  Détection stagnation + alternatives + rapport hebdo                ║
// ╚════════════════════════════════════════════════════════════════════╝
